...
<body>
	<div class="container">
		<ul class="nav nav-pills">
			<li class="active">
				<a data-toggle="modal" href="#createFolderModal" class="btn btn-primary btn-lg">Create Folder</a>
			</li>
			<li><form method="post" action="upload"
					enctype="multipart/form-data">
					<input type="file" multiple name= "fileName"> <input type="submit" value="Upload">
				</form>
			<li>
			...
			<table class="table table-condensed">
				...
				<c:if test="${currentFolder.idUpper!=0}">
					<form action="userfoldernav" method="post">
						<input type="hidden" name="folderId" value="${currentFolder.idUpper}">
						...
						<tr>
							<td>
								<label class="checkbox-inline">
									<input type="checkbox" id="inlineCheckbox1" name="folder" value="${folder.id}">
								</label>
							</td>
